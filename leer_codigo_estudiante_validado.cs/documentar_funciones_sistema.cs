...
namespace SoporteAcademicoUPN
{
    class Program
    {
                ...
                switch (opcion)
                {
                    case 1:
                        if (contadorSolicitudes < CAPACIDAD_MAXIMA)
                        {
                            ...
                            Console.WriteLine($"\n[ÉXITO] Solicitud N° {contadorSolicitudes} registrada. Prioridad: {prioridadTemp}");
                        }
                        else
                        {
                            Console.WriteLine($"[ALERTA] Capacidad máxima alcanzada ({CAPACIDAD_MAXIMA} solicitudes).");
                        }
                        break;
            ...
            int totalRegistrados)
        {
            ...
            {
                Console.WriteLine("[AVISO] No hay ninguna solicitud registrada aún.");
                return;
            }
