...
namespace SoporteAcademicoUPN
{
    class Program
    {
            ...
            do
            {
                ...
                switch (opcion)
                {
                    case 1:
                        ...
                        Console.WriteLine($"\n[ÉXITO] Solicitud registrada. Prioridad asignada: {prioridadAtencion}");
                        break;

                    case 2:
                        if (solicitudRegistrada)
                        {
                            MostrarResumenSolicitud(codigoEstudiante, nombreEstudiante, tipoConsulta, descripcionBreve, prioridadAtencion);
                        }
                        else
                        {
        ...
        static void MostrarResumenSolicitud(string codigo, string nombre, string tipo, string descripcion, string prioridad)
        {
